      ...
      <DeviceCard device={device} className={className}>
        <div className="flex flex-col items-center py-6 gap-3">
          <div className="relative flex items-center justify-center">
            ...
            <div 
              ref={dialRef}
              className="w-32 h-32 rounded-full border-4 border-primary bg-black shadow-lg flex items-center justify-center cursor-grab active:cursor-grabbing thermostat-dial"
            >
